            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            <a href="./BatimentServlet?action=modifierForm&id=<%= batiment.getId() %>" class="action-btn edit-btn">
                                <i class="fas fa-edit"></i> Modifier
                            </a>
                            <a href="BatimentServlet?action=supprimer&id=<%= batiment.getId() %>"
                               onclick="return confirm('Voulez-vous vraiment supprimer ce bâtiment ?');"
