...
(service != null) ? service.getDescription() : (groupe != null) ? groupe.getDescription() : "" %></textarea>
</div>
...
<%= (service != null && service.getParent()!=null && service.getParent().getId()==g.getId()) ? "selected" : "" %>>
<%= g.getNom() %>
</option>
...
<select name="chefId" class="form-control">
...
<%= (service != null && service.getChefId()!=null && service.getChefId()==chef.getId()) ? "selected" : "" %>>
...
onclick="window.location.href='ServiceServlet?action=list'">
Annuler
</button>
